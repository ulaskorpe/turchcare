        ...
        <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
          ...
          <ul class="nav navbar-nav float-xs-right">
            ...
            <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online">
              ...
              <div class="dropdown-menu dropdown-menu-right"><a href="{{route('profile')}}" class="dropdown-item"><i class="icon-head"></i> Profil Düzenle</a><a href="/admin-panel/messages" class="dropdown-item"><i class="icon-mail6"></i> Mesajlar</a>
                ...
                <form class="form" id="logout-form" name="logout-form" action="{{ route('logout') }}"
                    ...
                    <a href="#" onclick="logoutfx()" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
        ...
        <div class="fullscreen-search-content">
          ...
          <div class="fullscreen-search-result mt-2">
            <div class="row">
              <div class="col-lg-4">
                <h3>People</h3>
                <div class="media"><a href="#" class="media-left"><img src="" alt="Generic placeholder image" class="media-object rounded-circle"></a>
