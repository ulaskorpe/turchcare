...
<script src="{{url('assets/styles/bootstrap-4.1.2/popper.js')}}"></script>
<script src="{{url('assets/styles/bootstrap-4.1.2/bootstrap.min.js')}}"></script>
...
<script src="{{url('assets/plugins/jquery-datepicker/jquery-ui.js')}}"></script>
