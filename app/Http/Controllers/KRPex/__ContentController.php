...
class ContentController extends Controller
{
    ...
    public function create($type,$lang='tr',$parent_id=0){
        ...
        ,'fields'=>$fields ,'txt'=>$type['fields'],'langs'=>$this->lang_array,'lang'=>$lang,'count'=>$count,'product_cats'=>$product_cats,
        'post'=>null,'exe'=>"Ekle",'route'=>'content-create-post','submit'=>$this->submit_form ,'parent'=>$parent ,'parent_id'=>$parent_id,'cats'=>$cats,'tags'=>$tags,
